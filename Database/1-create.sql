...
CREATE TABLE Reception (
    Reception_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Member (
    Member_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    Card_ID CHAR(13) NOT NULL UNIQUE,
    Me_Prefix VARCHAR(200) NOT NULL,
    ...
    Me_Status VARCHAR(200) NOT NULL,
    Me_Blood CHAR(2) NOT NULL,
...
CREATE TABLE PackageLab (
    PackageLab_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    PackageLab_Name VARCHAR(200) NOT NULL,
    PackageLab_Price DECIMAL(65, 30)
);

CREATE TABLE LabTest (
    LabTest_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Items (
    Item_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE PackageItem (
    PackageI_ID INT INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
